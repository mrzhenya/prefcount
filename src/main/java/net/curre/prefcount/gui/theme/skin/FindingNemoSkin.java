...
/**
 * An object of this class represents the prefcount FindingNemoSkin skin -
 * the Substance's <code>org.jvnet.substance.skin.FindingNemoSkin</code>.
 * <p/>
 * Created date: Jun 14, 2007
 *
 * @author Yevgeny Nyden
 */
public class FindingNemoSkin implements PrefSkin {

  /** Resource key for the skin name and the skins unique ID. */
  public static final String NAME_KEY = "pref.skinMenu.findingNemo";

  /** Main background color. */
  public static final Color COLOR_BACKGROUND_MAIN = new Color(152, 225, 247);

  /** Board background paint. */
  public static final Color PAINT_BACKGROUND_BOARD = new Color(204, 255, 255);

  /** Color for players names. */
  private static final Color COLOR_PLAYER_NAME = new Color(237, 75, 232);
  ...
  private static final Color COLOR_PLAYER_SCORE = new Color(173, 103, 237);
  ...
  private static final Color COLOR_PLAYER_TOTALS = new Color(173, 103, 237);
  ...
  private static final Color COLOR_BOARD_LINES = new Color(66, 174, 93);

  /** Color for the board lines. */
  private static final Stroke STROKE_BOARD_LINES = new BasicStroke(1);

  /** Paint to heighlight final score polygon. */
  private static final Paint PAINT_FINAL_SCORE_BACKGROUND = new Color(66, 174, 93, 50);

  /** Paint for the main player section division lines. */
  private static final Paint PAINT_MAIN_SECTION_LINES = new Color(30, 100, 50);

  /** {@inheritDoc} */
  public String getSubstanceSkinClassName() {
    return org.jvnet.substance.skin.FindingNemoSkin.class.getName();
  }
