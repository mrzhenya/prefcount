...
/**
 * An object of this class represents the prefcount FieldOfWheatSkin skin -
 * the Substance's <code>org.jvnet.substance.skin.FieldOfWheatSkin</code>.
 * <p/>
 * Created date: Jun 14, 2007
 *
 * @author Yevgeny Nyden
 */
public class FieldOfWheatSkin implements PrefSkin {

  /** Resource key for the skin name and the skins unique ID. */
  public static final String NAME_KEY = "pref.skinMenu.fieldOfWeat";

  /** Main background color. */
  public static final Color COLOR_BACKGROUND_MAIN = new Color(230, 219, 142);

  /** Board background paint. */
  public static final Color PAINT_BACKGROUND_BOARD = new Color(255, 255, 202);

  /** Color for players names. */
  private static final Color COLOR_PLAYER_NAME = new Color(99, 202, 236);
  ...
  private static final Color COLOR_PLAYER_SCORE = new Color(92, 70, 33);

  /** Font for players scores. */
  private static final Font FONT_PLAYER_SCORE = new Font("Arial Black", Font.PLAIN, 16);

  /** Stroke for players scores. */
  private static final Stroke STROKE_PLAYER_SCORE = new BasicStroke(1);

  /** Color for players totals (scores). */
  private static final Color COLOR_PLAYER_TOTALS = new Color(92, 70, 33);
  ...
  private static final Color COLOR_BOARD_LINES = new Color(194, 145, 40);

  /** Color for the board lines. */
  private static final Stroke STROKE_BOARD_LINES = new BasicStroke(1);

  /** Paint to heighlight final score polygon. */
  private static final Paint PAINT_FINAL_SCORE_BACKGROUND = new Color(99, 202, 236, 50);

  /** Paint for the main player section division lines. */
  private static final Paint PAINT_MAIN_SECTION_LINES = new Color(80, 50, 15);

  /** {@inheritDoc} */
  public String getSubstanceSkinClassName() {
    return org.jvnet.substance.skin.FieldOfWheatSkin.class.getName();
  }
  ...
  public Paint getBoardBackgroundPaint() {
    return new GradientPaint(200f, 200f, PAINT_BACKGROUND_BOARD,
                             500f, 500f, Utilities.createDarkerColor(PAINT_BACKGROUND_BOARD, 20));
  }
