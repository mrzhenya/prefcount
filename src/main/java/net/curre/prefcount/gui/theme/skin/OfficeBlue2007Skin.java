...
/**
 * An object of this class represents the prefcount OfficeBlue2007Skin skin -
 * the Substance's <code>org.jvnet.substance.skin.OfficeBlue2007Skin</code>.
 * <p/>
 * Created date: Jun 14, 2007
 *
 * @author Yevgeny Nyden
 */
public class OfficeBlue2007Skin implements PrefSkin {

  /** Resource key for the skin name and the skins unique ID. */
  public static final String NAME_KEY = "pref.skinMenu.officeBlue";

  /** Main background color. */
  public static final Color COLOR_BACKGROUND_MAIN = new Color(162, 211, 244);

  /** Board background paint. */
  public static final Color PAINT_BACKGROUND_BOARD = new Color(238, 254, 255);
  ...
  private static final Color COLOR_PLAYER_SCORE = new Color(30, 45, 53);
  ...
  private static final Color COLOR_PLAYER_TOTALS = new Color(30, 45, 53);
  ...
  private static final Color COLOR_BOARD_LINES = new Color(69, 103, 122);

  /** Color for the board lines. */
  private static final Stroke STROKE_BOARD_LINES = new BasicStroke(2);

  /** Paint to heighlight final score polygon. */
  private static final Paint PAINT_FINAL_SCORE_BACKGROUND = new Color(69, 103, 122, 40);

  /** Paint for the main player section division lines. */
  private static final Paint PAINT_MAIN_SECTION_LINES = new Color(42, 62, 74);

  /** {@inheritDoc} */
  public String getSubstanceSkinClassName() {
    return org.jvnet.substance.skin.OfficeBlue2007Skin.class.getName();
  }
