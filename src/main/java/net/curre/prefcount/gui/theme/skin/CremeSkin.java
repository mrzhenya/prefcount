...
/**
 * An object of this class represents the prefcount Creme skin -
 * the Substance's <code>org.jvnet.substance.skin.CremeSkin</code>.
 * <p/>
 * Created date: Jun 14, 2007
 *
 * @author Yevgeny Nyden
 */
public class CremeSkin implements PrefSkin {

  /** Resource key for the skin name and the skins unique ID. */
  public static final String NAME_KEY = "pref.skinMenu.creme";

  /** Main background color. */
  public static final Color COLOR_BACKGROUND_MAIN = new Color(237, 241, 229);
  ...
  private static final Font FONT_PLAYER_NAME = new Font("Arial Black", Font.PLAIN, 16);
  ...
  private static final Font FONT_PLAYER_TOTALS = new Font("Arial Black", Font.PLAIN, 16);
  ...
  private static final Color COLOR_BOARD_LINES = new Color(0, 0, 0);

  /** Color for the board lines. */
  private static final Stroke STROKE_BOARD_LINES = new BasicStroke(1);

  /** Paint to heighlight final score polygon. */
  private static final Paint PAINT_FINAL_SCORE_BACKGROUND = new Color(150, 150, 150, 60);
  ...
  public String getSubstanceSkinClassName() {
    return org.jvnet.substance.skin.CremeSkin.class.getName();
  }
