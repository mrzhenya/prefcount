...
/**
 * An object of this class represents the prefcount Business skin -
 * the Substance's <code>org.jvnet.substance.skin.BusinessSkin</code>.
 * <p/>
 * Created date: Jun 13, 2007
 *
 * @author Yevgeny Nyden
 */
public class BusinessSkin implements PrefSkin {

  /** Resource key for the skin name and the skins unique ID. */
  public static final String NAME_KEY = "pref.skinMenu.business";

  /** Main background color. */
  public static final Color COLOR_BACKGROUND_MAIN = new Color(209, 214, 220);

  /** Board background paint. */
  public static final Color PAINT_BACKGROUND_BOARD = new Color(173, 180, 188);

  /** Color for players names. */
  private static final Color COLOR_PLAYER_NAME = new Color(255, 255, 255);
  ...
  private static final Color COLOR_PLAYER_SCORE = new Color(255, 255, 255);
  ...
  private static final Color COLOR_PLAYER_TOTALS = new Color(255, 255, 255);
  ...
  private static final Color COLOR_BOARD_LINES = new Color(255, 255, 255);

  /** Color for the board lines. */
  private static final Stroke STROKE_BOARD_LINES = new BasicStroke(1);

  /** Paint to heighlight final score polygon. */
  private static final Paint PAINT_FINAL_SCORE_BACKGROUND = new Color(250, 250, 250, 80);

  /** Paint for the main player section division lines. */
  private static final Paint PAINT_MAIN_SECTION_LINES = new Color(255, 255, 255);

  /** {@inheritDoc} */
  public String getSubstanceSkinClassName() {
    return org.jvnet.substance.skin.BusinessSkin.class.getName();
  }
