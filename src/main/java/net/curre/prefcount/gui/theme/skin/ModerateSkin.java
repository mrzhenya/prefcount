...
/**
 * An object of this class represents the prefcount ModerateSkin skin -
 * the Substance's <code>org.jvnet.substance.skin.ModerateSkin</code>.
 * <p/>
 * Created date: Jun 14, 2007
 *
 * @author Yevgeny Nyden
 */
public class ModerateSkin implements PrefSkin {

  /** Resource key for the skin name and the skins unique ID. */
  public static final String NAME_KEY = "pref.skinMenu.moderate";

  /** Main background color. */
  public static final Color COLOR_BACKGROUND_MAIN = new Color(232, 238, 244);
  ...
  private static final Color COLOR_PLAYER_SCORE = new Color(58, 79, 92);
  ...
  private static final Color COLOR_PLAYER_TOTALS = new Color(58, 79, 92);
  ...
  private static final Color COLOR_BOARD_LINES = new Color(133, 180, 209);

  /** Color for the board lines. */
  private static final Stroke STROKE_BOARD_LINES = new BasicStroke(2);

  /** Paint to heighlight final score polygon. */
  private static final Paint PAINT_FINAL_SCORE_BACKGROUND = new Color(133, 180, 209, 70);

  /** Paint for the main player section division lines. */
  private static final Paint PAINT_MAIN_SECTION_LINES = new Color(80, 108, 126);

  /** {@inheritDoc} */
  public String getSubstanceSkinClassName() {
    return org.jvnet.substance.skin.ModerateSkin.class.getName();
  }
