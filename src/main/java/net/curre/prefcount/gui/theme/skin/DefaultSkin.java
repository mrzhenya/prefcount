...
/**
 * An object of this class represents the prefcount default skin -
 * the system default skin.
 * <p/>
 * Created date: Jun 13, 2007
 *
 * @author Yevgeny Nyden
 */
public class DefaultSkin implements PrefSkin {

  /** Resource key for the skin name and the skins unique ID. */
  public static final String NAME_KEY = "pref.skinMenu.default";
